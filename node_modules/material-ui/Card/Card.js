...
var styleSheet = exports.styleSheet = (0, _createStyleSheet2.default)('MuiCard', {
  root: {
    overflow: 'hidden'
  }
});
...
Card.propTypes = process.env.NODE_ENV !== "production" ? (_ref = {
  classes: require('prop-types').object.isRequired,
  raised: require('prop-types').bool.isRequired
}, (0, _defineProperty3.default)(_ref, 'classes', require('prop-types').object), (0, _defineProperty3.default)(_ref, 'className', require('prop-types').string), (0, _defineProperty3.default)(_ref, 'raised', require('prop-types').bool), _ref) : {};
Card.defaultProps = {
  raised: false
};
