...
var styleSheet = exports.styleSheet = (0, _createStyleSheet2.default)('MuiCardHeader', function (theme) {
  return {
    root: {
      display: 'flex',
      alignItems: 'center'
