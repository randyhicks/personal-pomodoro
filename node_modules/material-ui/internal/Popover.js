...
var babelPluginFlowReactPropTypes_proptype_Props = {
  ...
  transitionDuration: require('prop-types').oneOfType([require('prop-types').number, require('prop-types').oneOf(['auto'])]).isRequired,
