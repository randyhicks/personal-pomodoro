...
var Portal = function (_Component) {
  ...
  function Portal() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Portal.__proto__ || (0, _getPrototypeOf2.default)(Portal)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      mounted: false
    }, _this.layer = null, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  (0, _createClass3.default)(Portal, [{
    ...
    value: function renderLayer() {
      ...
      if (open) {
        ...
        var layerElement = _react.Children.only(children);
    ...
    value: function render() {
      ...
      if (this.state.mounted) {
        if (open) {
          _reactDom2.default.unstable_createPortal(children, this.getLayer());
        } else {
          this.unrenderLayer();
        }
      }
